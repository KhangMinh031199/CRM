...
$(document).ready(function () {
    ...
    $("#save_connect_success").click(function () {
        ...
        $.ajax({
            ...
            processData: false,
            success: function () {
                var url_preiew = '/preview/' + type_page + '/' + shop_id_select + '/' + camp_id + '/4';
                $("#preview").empty();
    ...
    $("#save_campaign").click(function () {
        ...
        form_data.append('camp_init', $('#camp_init').val());
        ...
        $.ajax({
            url: "/save_new_campaign/" + shop_id_select + "/" + camp_id,
            type: 'POST',
            data: form_data,
            contentType: false,
            processData: false,
    ...
    $("#view").click(function () {
        ...
        if (type_page == "khai_bao_y_te") {
            ...
            var url_pre = '/preview/' + type_page + '/' + shop_id_select + '/' + camp_id + '/' + curr_step_view;
        }
        if (type_page != "0") {
