(() = > {
    var e, t = {
        ...
        444: (e, t, a) = > {
            "use strict";
            var o = a(138);
            const n = document.querySelector("#popoverDemo"), l = document.querySelector("#offcanvasDemo"), r = document.querySelector("#topnav"), s = document.querySelector("#topbar"), c = document.querySelector("#sidebar"), i = document.querySelector("#sidebarSmall"), d = document.querySelector("#sidebarUser"), u = document.querySelector("#sidebarSmallUser"), p = document.querySelector("#sidebarSizeContainer"), h = document.querySelectorAll('input[name="navPosition"]'), f = document.querySelectorAll('[class^="container"]'), b = document.querySelector("#stylesheetLight"), m = document.querySelector("#stylesheetDark"), y = {
            ...
            ! function() {
                if (n) {
                    const e = JSON.parse(y.showPopover) && "base" === y.sidebarSize, t = new o.J2(n, {
                        offset: [0, 16],
                        placement: "top",
            ...
            function() {
                ...
                for (let t = 0; t < e.length; t++) {
                    const a = e[t].split("="), o = a[0], n = a[1];
                    "colorScheme" != o && "navPosition" != o && "navColor" != o && "sidebarSize" != o || (localStorage.setItem("dashkit" + o.charAt(0).toUpperCase() + o.slice(1), n), y[o] = n)
                }
            }(), "light" == (S = y.colorScheme) ? (b.disabled = !1, m.disabled = !0, S = "light") : "dark" == S && (b.disabled = !0, m.disabled = !1, S = "dark"),
            function(e) {
                if (r && s && c && i && d && u) if ("topnav" == e) {
                    g(s), g(c), g(i);
                    for (let e = 0; e < f.length; e++) f[e].classList.remove("container-fluid"), f[e].classList.add("container")
                } else if ("combo" == e) {
                    g(r), g(d), g(u);
                    for (let e = 0; e < f.length; e++) f[e].classList.remove("container"), f[e].classList.add("container-fluid")
                } else if ("sidenav" == e) {
                    g(r), g(s);
                    for (let e = 0; e < f.length; e++) f[e].classList.remove("container"), f[e].classList.add("container-fluid")
                }
            }(y.navPosition), w = y.navColor, c && i && r && ("default" == w ? (c.classList.add("navbar-light"), i.classList.add("navbar-light"), r.classList.add("navbar-light")) : "inverted" == w ? (c.classList.add("navbar-dark"), i.classList.add("navbar-dark"), r.classList.add("navbar-dark")) : "vibrant" == w && (c.classList.add("navbar-dark", "navbar-vibrant"), i.classList.add("navbar-dark", "navbar-vibrant"), r.classList.add("navbar-dark", "navbar-vibrant"))), "base" == (L = y.sidebarSize) ? g(i) : "small" == L && g(c), l && function(e, t, a, o, n) {
                e.querySelector('[name="colorScheme"][value="' + t + '"]').checked = !0, e.querySelector('[name="navPosition"][value="' + a + '"]').checked = !0, e.querySelector('[name="navColor"][value="' + o + '"]').checked = !0, e.querySelector('[name="sidebarSize"][value="' + n + '"]').checked = !0
            }(l, y.colorScheme, y.navPosition, y.navColor, y.sidebarSize), p && v(y.navPosition), document.body.style.display = "block", l && (l.addEventListener("submit", (function(e) {
                e.preventDefault(),
                function(e) {
                    const t = e.querySelector('[name="colorScheme"]:checked').value, a = e.querySelector('[name="navPosition"]:checked').value, o = e.querySelector('[name="navColor"]:checked').value, n = e.querySelector('[name="sidebarSize"]:checked').value;
        ...
        328: () = > {
            ...
            "undefined" != typeof mapboxgl && e.forEach((e = > {
                const t = {...e.dataset.map ? JSON.parse(e.dataset.map) : {}, ... {
                        container: e,
        ...
        524: (e, t, a) = > {
            ...
            document.querySelectorAll("[data-autosize]").forEach((e = > {
                (0, n.Z)(e)
            })), window.autosize = n.Z, window.Alert = o.bZ, window.Button = o.zx, window.Carousel = o.lr, window.Collapse = o.UO, window.Dropdown = o.Lt, window.Modal = o.u_, window.Offcanvas = o.TB, window.Popover = o.J2, window.ScrollSpy = o.DA, window.Tab = o.OK, window.Toast = o.FN, window.Tooltip = o.u;
            var l = a(320);
                        ...
                        callbackOnCreateTemplates: function(e) {
                            return {
                                choice: (t, a) = > {
                                    ...
                                    }`, n = a.disabled ? 'data-choice-disabled aria-disabled="true"' : "data-choice-selectable", l = a.groupId > 0 ? 'role="treeitem"' : 'role="option"', r = this.config.itemSelectText, s = a.customProperties && a.customProperties.avatarSrc ? `\n < div class = "avatar avatar-xs me-3" > \n < img class = "avatar-img rounded-circle"
                                    src = "${a.customProperties.avatarSrc}"
        ...
        document.querySelectorAll("[data-dropzone]").forEach((e = > {
            let t;
            const a = e.dataset.dropzone ? JSON.parse(e.dataset.dropzone) : {}, o = {
        ...
        h().registerLanguage("xml", y()), h().registerLanguage("javascript", b()), k.forEach((e = > {
            h().highlightBlock(e)
        })), window.hljs = h();
        var v = a(382),
            g = a.n(v);
        ...
        g()({
            rightAlign: !1
        }).mask(S), window.Inputmask = g();
        const w = document.querySelectorAll(".kanban-category"), L = document.querySelectorAll(".kanban-add-link"), C = document.querySelectorAll(".kanban-add-form");

        function E(e) {
            const t = e.closest(".kanban-add"), a = t.querySelector(".card"), o = t.querySelector(".kanban-add-link"), n = t.querySelector(".kanban-add-form");
        ...
        ! function() {
            ...
            void 0 !== O() && e && [].forEach.call(e, (function(e) {
                ! function(e) {
                    const t = e.querySelector(".list-alert"), o = e.querySelector(".list-alert-count"), n = e.querySelector(".list-alert .btn-close"), l = e.querySelectorAll(".list-checkbox"), r = e.querySelector(".list-checkbox-all"), s = e.querySelectorAll(".list-pagination"), c = e.querySelector(".list-pagination-prev"), i = e.querySelector(".list-pagination-next"), d = e.dataset.list && JSON.parse(e.dataset.list), u = Object.assign({
                        listClass: "list",
        ...
        window.innerWidth > 767 && q.forEach((e = > {
            const t = e.querySelector('[data-bs-toggle="dropdown"]'), a = new o.Lt(t);
        ...
        document.querySelectorAll("[data-quill]").forEach((e = > {
            const t = {...e.dataset.quill ? JSON.parse(e.dataset.quill) : {}, modules: {
                    toolbar: [
                        ["bold", "italic"],
        ...
        document.querySelectorAll('[data-toggle="wizard"]').forEach((e = > {
            const t = new o.OK(e), a = e.closest(".tab-content").querySelectorAll(".tab-pane");
            e.addEventListener("click", (function(o) {
                o.preventDefault(), a.forEach((e = > {
                    e.classList.remove("active")
                })), t.show(), e.classList.remove("active")
            }))
        }));
        var I = a(560);
        ...
        }, N = "Cerebri Sans", P = document.querySelectorAll('[data-toggle="chart"]'), z = document.querySelectorAll('[data-toggle="legend"]');
        ...
        function M(e) {
            ...
            if (a.body) {
                const e = a.title || [], n = a.body.map((e = > e.lines)), l = document.createElement("div");
                e.forEach((e = > {
                ...
                n.forEach(((e, o) = > {
                    const l = a.labelColors[o], s = document.createElement("span");
            ...
            o.style.visibility = "visible", o.style.left = n + a.caretX + "px", o.style.top = l + a.caretY + "px", o.style.transform = "translateX(-50%) translateY(-100%) translateY(-1rem)"
        }
        function B(e) {
            let t = "";
            const a = e.chart.scales[e.dataset.yAxisID || "y"];
            if (a) {
                t = (e.chart.tooltip.dataPoints.length > 1 ? " " + e.dataset.label + " " : " ") + a.options.ticks.callback.apply(a, [e.parsed.y, 0, []])
            } else {
                const a = e.chart.options.plugins.tooltip.callbacks, o = a.beforeLabel() || "", n = a.afterLabel() || "";
                t = o + e.formattedValue + n
            }
            return t
        }
        I.kL.defaults.responsive = !0, I.kL.defaults.maintainAspectRatio = !1, I.kL.defaults.color = T("--bs-chart-default-color"), I.kL.defaults.font.family = N, I.kL.defaults.font.size = 13, I.kL.defaults.layout.padding = 0, I.kL.defaults.plugins.legend.display = !1, I.kL.defaults.elements.point.radius = 0, I.kL.defaults.elements.point.backgroundColor = J.primary[700], I.kL.defaults.elements.line.tension = .4, I.kL.defaults.elements.line.borderWidth = 3, I.kL.defaults.elements.line.borderColor = J.primary[700], I.kL.defaults.elements.line.backgroundColor = J.transparent, I.kL.defaults.elements.line.borderCapStyle = "rounded", I.kL.defaults.elements.bar.backgroundColor = J.primary[700], I.kL.defaults.elements.bar.borderWidth = 0, I.kL.defaults.elements.bar.borderRadius = 10, I.kL.defaults.elements.bar.borderSkipped = !1, I.kL.defaults.datasets.bar.maxBarThickness = 10, I.kL.defaults.elements.arc.backgroundColor = J.primary[700], I.kL.defaults.elements.arc.borderColor = T("--bs-chart-arc-border-color"), I.kL.defaults.elements.arc.borderWidth = 4, I.kL.defaults.elements.arc.hoverBorderColor = T("--bs-chart-arc-hover-border-color"), I.kL.defaults.plugins.tooltip.enabled = !1, I.kL.defaults.plugins.tooltip.mode = "index", I.kL.defaults.plugins.tooltip.intersect = !1, I.kL.defaults.plugins.tooltip.external = M, I.kL.defaults.plugins.tooltip.callbacks.label = B, I.kL.defaults.datasets.doughnut.cutout = "83%", I.kL.defaults.scales.linear.border = {...I.kL.defaults.scales.linear.border, display: !1,
            dash: [2],
            dashOffset: [2]
        }, I.kL.defaults.scales.linear.grid = {...I.kL.defaults.scales.linear.grid, color: T("--bs-chart-grid-line-color"),
            drawTicks: !1
        }, I.kL.defaults.scales.linear.ticks.beginAtZero = !0, I.kL.defaults.scales.linear.ticks.padding = 10, I.kL.defaults.scales.linear.ticks.stepSize = 10, I.kL.defaults.scales.category.border = {...I.kL.defaults.scales.category.border, display: !1
        }, I.kL.defaults.scales.category.grid = {...I.kL.defaults.scales.category.grid, display: !1,
            drawTicks: !1,
            drawOnChartArea: !1
        }, I.kL.defaults.scales.category.ticks.padding = 20, P.forEach((function(e) {
            const t = e.dataset.trigger;
            e.addEventListener(t, (function() {
                ! function(e) {
                    const t = e.dataset.target, a = e.dataset.action, o = parseInt(e.dataset.dataset), n = document.querySelector(t), l = I.kL.getChart(n);
                    if ("toggle" === a) {
                    ...
                    if ("add" === a) {
                        const e = l.data.datasets[o], t = e.hidden;
                        e.hidden = !t
                    }
                    l.update()
                }(e)
            ...
            z.forEach((function(e) {
                ! function(e) {
                    ...
                    t.legend.legendItems ? .forEach((e = > {
                        a.innerHTML += ` < span class = "chart-legend-item" > < span class = "chart-legend-indicator"
                        style = "background-color: ${e.fillStyle}" > < /span>${e.text}</span > `
                    }));
...
o.m = t, e = [], o.O = (t, a, n, l) = > {
    if (!a) {
        ...
        for (d = 0; d < e.length; d++) {
            for (var [a, n, l] = e[d], s = !0, c = 0; c < a.length; c++)(!1 & l || r >= l) && Object.keys(o.O).every((e = > o.O[e](a[c]))) ? a.splice(c--, 1) : (s = !1, l < r && (r = l));
            if (s) {
                e.splice(d--, 1);
                var i = n();
                void 0 !== i && (t = i)
