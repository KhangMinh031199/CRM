...
function alertWinResult(e) {
    ...
    document.getElementById('spinWinResult').innerText = "Bạn còn " + number_spin + " lượt quay";
    $("#spin").modal("show");
    $(".power_controls").show();
};
...
function SetJSONvalues() {
    ...
    var t = 'http://static.nextify.vn/static/uploads/{{ shop.logo }}',
...
$(document).on("click", "#spin_button", function () {
    ...
    if (0 == globlefuncgeneral.wheelSpinning) {
        ...
        globlefuncgeneral.theWheel.animation.stopAngle = globlefuncgeneral.theWheel.getRandomForSegment(e);
        0 == globlefuncgeneral.arrsp.length && (globlefuncgeneral.arrsp = globlefuncgeneral.strarr.split("|"));
        globlefuncgeneral.theWheel.startAnimation();
        globlefuncgeneral.wheelSpinning = !0
    }
});
